...
function addApendiceLista(array, valor) {
...
function redirecione(usuario) {
  if ('cargo' in usuario) {//redirecionar para a área de administração
  } //se nn redirecionar para a área do usuário

}

function redirecionar2(usuario) {
  if (usuario.cargo) {//redirecionar (usuario.cargo)
...
var cao = new MeuCachorro('Apolo', 14); //COMO IMPORTAR BIBLIOTECAS COM TYPESCRIPT
...
//# sourceMappingURL=/intro.77de5100.js.map